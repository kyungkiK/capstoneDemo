...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">검색 페이지 입니다.</h1>
        </div>
    </div>
</header>
<!-- Section-->
<section class="py-5">
    <form method="post" action="">
        <div class="searchEg" align="center">
            <input type="text" class="input_search" placeholder="검색어를 입력해주세요" required/>
            <input type="submit" class="btn btn-outline-dark mt-auto" value="검색"/>
        </div>
    </form>
</section>
        <%
